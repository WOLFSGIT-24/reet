...
export const PROJECTS_DATA = [
  {
    ...
    builderPrice: '₹3.66 – 4.3 Cr',
    builderPriceMin: 3.66,
    builderPriceMax: 4.30,
    groupPrice: '₹3.5 – 4.2 Cr',
    groupPriceMin: 3.50,
    groupPriceMax: 4.20,
  ...
  },
  {
    ...
    builderPrice: '₹2.81 – 5.30 Cr',
    builderPriceMin: 2.81,
    builderPriceMax: 5.30,
    groupPrice: '₹2.64 – 5.1 Cr',
    groupPriceMin: 2.64,
    groupPriceMax: 5.10,
    minGroupPill: 'Min. group: 4 buyers',
  ...
  },
  {
    ...
    title: 'Avira by AVR',
    location: 'Narsingi',
    builder: '3 BHK · 2,292–2,680 sq.ft · AVR Builders',
    builderPrice: '₹1.94 – 2.39 Cr',
    builderPriceMin: 1.94,
    builderPriceMax: 2.39,
    groupPrice: '₹1.85 – 2.25 Cr',
    groupPriceMin: 1.85,
    groupPriceMax: 2.25,
    minGroupPill: 'Min. group: 4 buyers',
    image: aviraImg
  },
  {
    ...
    location: 'Kondapur',
    builder: '3 & 4 BHK · 1,760–4,685 sq.ft · Hallmark Builders',
    builderPrice: '₹1.46 – 5.3 Cr',
    builderPriceMin: 1.46,
    builderPriceMax: 5.30,
    groupPrice: '₹1.39 – 5.1 Cr',
    groupPriceMin: 1.39,
    groupPriceMax: 5.10,
    minGroupPill: 'Min. group: 4 buyers',
    image: altusImg
  },
  {
    ...
    location: 'Kokapet',
    builder: '3 BHK · 1,798–2,388 sq.ft · Raghava Projects',
    builderPrice: '₹1.8 – 2.5 Cr',
    builderPriceMin: 1.80,
    builderPriceMax: 2.50,
    groupPrice: '₹1.65 – 2.3 Cr',
    groupPriceMin: 1.65,
    groupPriceMax: 2.30,
    minGroupPill: 'Min. group: 4 buyers',
  ...
  },
  {
    ...
    builder: '3 BHK · 1,905–2,454 sq.ft · Raghava Projects',
    builderPrice: '₹1.5 – 2.15 Cr',
  ...
  },
  {
    ...
    location: 'Kokapet',
    builder: '3 BHK · 3,520–3,720 sq.ft · Simchah Estates Pvt Ltd',
    builderPrice: '₹4 – 4.65 Cr',
    builderPriceMin: 4.00,
    builderPriceMax: 4.65,
    groupPrice: '₹3.9 – 4.55 Cr',
    groupPriceMin: 3.90,
    groupPriceMax: 4.55,
    minGroupPill: 'Min. group: 4 buyers',
